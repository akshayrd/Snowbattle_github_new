...
//        [self addChild:monster6];
        ...
        {
            shopPowerUp2 = [CCMenuItemImage itemFromNormalImage:@"NoMoreGhostPowerUp_45x45.png" selectedImage:@"NoMoreGhostPowerUp_45x45.png" target:self selector:@selector(Closepit:)];
            shopPowerUp2.visible = true;
    ...
    //                    [self addChild:p1];
    //
    //                    shopPowerUp2 = [CCMenuItemImage itemFromNormalImage:@"NoMoreGhostPowerUp_45x45.png" selectedImage:@"NoMoreGhostPowerUp_45x45.png" target:self selector:Nil];
